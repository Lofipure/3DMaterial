...
import { Op, Model as SeqModel, fn, col } from "sequelize";
...
/** 获取模型维度的分析数据 */
export const getModelVisitAnalyze = async (): Promise<AnalyzeResType.IModelVisitAnalyze> => {
  const modelVisit = (
    await Visit.findAll({
...
// 系统数据综合分析
export const getComprehensiveAyalyze = async (): Promise<AnalyzeResType.IComprehensiveAnalyze> => {
